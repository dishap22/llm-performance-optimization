...
def plot_gpu_linear(results_df, save_path="benchmark_results_gpu_linear.png"):
    ...
    ax1.set_title(f'GPU SpGEMM Performance vs Matrix Size (Density: {density})')
    ax1.legend()
    ...
    ax2.set_title(f'GPU SpGEMM Performance vs Density (Size: {size}x{size})')
    ax2.legend()
    ...
    # Plot 3: Relative Performance (normalized to cuSPARSE, fixed size/density)
